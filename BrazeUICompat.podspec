Pod::Spec.new do |s|
  ...
  s.source            = { :git => 'https://github.com/braze-inc/braze-swift-sdk-hang-investigation.git', :tag => '11.1.0-instrumentation' }
  ...
  s.dependency 'BrazeKitCompat', '11.1.0-instrumentation'
